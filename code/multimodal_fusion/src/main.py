...
MODEL_NAME = 'mlB-image-textt' #nama model untuk membedakan hasil training dan penyimpanan model
...
def  main():
    ...
    # Fallback criterion; train/eval will prefer model.compute_loss when available.
