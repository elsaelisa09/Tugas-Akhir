...
% 	\rfoot{Halaman \thepage}%
    ...
    % Judul Tugas Akhir
    \title{Identifikasi Meme \textit{Self-Harm} Menggunakan \textit{Intermediate Fusion} Model Multimodal CLIP dan ELECTRA} % Judul Tugas Akhir dalam Bahasa Indonesia	
